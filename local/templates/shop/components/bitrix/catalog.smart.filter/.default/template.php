...
?>
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="catalog-page__filter catalog__filter form bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>">
									...
									<div class="form__content-group">
										<?foreach ($arItem["VALUES"] as $val => $ar):?>
											<div class="checkbox-tile checkbox-tile_size_big">
												<input id="<?=$ar["CONTROL_ID"]?>" name="<?=$ar["CONTROL_NAME"]?>" type="checkbox" value="<?=$ar["HTML_VALUE"]?>" class="checkbox-tile__elem" <? echo $ar["CHECKED"]? 'checked="checked"': '' ?>>
												<label  onclick="smartFilter.keyup(BX('<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')); BX.toggleClass(this, 'bx-active');" data-role="label_<?=$ar["CONTROL_ID"]?>" style="background-image:url('<?=$ar["FILE"]["SRC"]?>');" for="<?=$ar["CONTROL_ID"]?>" class="checkbox-tile__label checkbox-tile__label_color_green checkbox-tile__label_type_color">
												</label>
										</div>
													...
													<? foreach($arItem["VALUES"] as $val => $ar): ?>
														<div class="checkbox-tile checkbox-tile_size_big">
															<input 
																...
																onclick="smartFilter.click(this)"	
															>
															<label data-role="label_<?=$ar["CONTROL_ID"]?>" for="<? echo $ar["CONTROL_ID"] ?>" class="checkbox-tile__label"><?=$ar["VALUE"];?></label>
														</div>
													<? endforeach ?>
												</div>		
									</div>		
										...
										<div class="form__row form__row_direction_column">
											...
											<?foreach($arItem["VALUES"] as $val => $ar):?>
												<div class="checkbox">
													...
													<label data-role="label_<?=$ar["CONTROL_ID"]?>" for="<? echo $ar["CONTROL_ID"] ?>" class="checkbox__label form__label"><?= $ar["VALUE"] ?></label>
												</div>
											<? endforeach ?>	
										</div>	
									<? endif ?>
