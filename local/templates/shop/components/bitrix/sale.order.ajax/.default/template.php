				...
				<form class="form js-form-validate order-page__form">
								...
								<div class="goods-table__row">
									<div class="goods-table__cell">
										...
										<div class="goods-table__col">
											...
											<div class="goods-table__info">Размер: <?= $item["PROPS"][2]["VALUE"] ?></div>
										</div>
									</div>
									<? if($item["DISCOUNT_PRICE"] != 0): ?>
										<div class="goods-table__cell">
									...
									<div class="goods-table__cell">
										<? if($item["DISCOUNT_PRICE"] != 0): ?>
											<div class="goods-table__text goods-table__text_discount"><?= $item["PRICE_FORMATED"] ?> руб.</div>
										<? else: ?>
					...
					<div class="form__total">
						<div class="form__col-right">
							<div class="form__total-row form__total-row_goods-cost"><span class="form__total-item">Товаров на сумму:</span><span class="form__total-item"><?= $arResult["JS_DATA"]["TOTAL"]["ORDER_TOTAL_PRICE"] ?> руб.</span>
							</div>
							<div class="form__total-row form__total-row_tax"><span class="form__total-item">В том числе НДС:</span><span class="form__total-item"><?= $arResult["JS_DATA"]["TOTAL"]["VAT_SUM"]?> руб.</span>
							</div>
							<div class="form__total-row form__total-row_general"><span class="form__total-item">Итого</span>
								<div class="form__total-item form__total-item_sum"><?= $arResult["JS_DATA"]["TOTAL"]["ORDER_TOTAL_PRICE"] ?> руб.</div>
							</div>
