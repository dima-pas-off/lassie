...
<? 
	...
	$sectionDescription = "<p data-block='0' class='catalog-page__text'>" . $arResult["DESCRIPTION"] . "</p>";
	$APPLICATION->AddViewContent("section_description", $sectionDescription);

?>

<div class="catalog-main" data-entity="<?=$containerName?>">
...
<div class="catalog__sort">
	...
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
		...
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
			...
			?>							
			<div class="catalog__goods-wrapper" data-entity="items-row">
				<?
...
<div class="catalog__more">
        ...
        <span class="icon-load"></span>Загрузить</a>
		</div>
